...
switch (day1){
    case 1: console.log('Cьогодні понеділок, вивчаємо HTML/CSS.');
    break;
    case 2: console.log('Cьогодні вівторок, вивчаємо JS.');
        break;
    case 3: console.log('Cьогодні середа, вивчаємо React.');
        break;
    case 4: console.log('Cьогодні четверг, вивчаємо Angular.');
        break;
    case 5: console.log('Cьогодні п\'ятниця, вивчаємо Node.js.');
        break;
    case 6: console.log('Cьогодні субота, вивчаємо англійську');
        break;
    case 7: console.log('Cьогодні неділя, відпочиваємо.');
        break;
    default: console.log('Некоректно введено номер дня тижня.');
